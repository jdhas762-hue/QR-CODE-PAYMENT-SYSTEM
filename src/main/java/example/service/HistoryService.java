...
public class HistoryService {
    public List<Payment> getPayments(User user) throws InterruptedException, ExecutionException {
    ...
    public List<Payment> getMerchantPayments(MerchantUser merchant) throws InterruptedException, ExecutionException {
